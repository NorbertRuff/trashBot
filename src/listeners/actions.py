"""
This Listener is responsible for handling action generated by the buttons in the slack workspace.
"""
...
class ActionListener:
    ...
    def handle_open_add_trash_videos_modal(self, body: dict, client: WebClient, ack: Ack, logger: Logger):
        """Return the add trash videos modal"""
        logger.info(body)
        ack()
        try:
            client.views_open(
    ...
    def handle_open_send_trash_to_user_modal(self, body: dict, client: WebClient, ack: Ack, logger: Logger):
        """Return the send trash to user modal"""
        logger.info(body)
        ack()
    ...
    def handle_open_send_trash_to_channel_modal(self, body: dict, client: WebClient, ack: Ack, logger: Logger):
        """Return the send trash to channel modal"""
        logger.info(body)
        ack()
        try:
            client.views_open(
    ...
    def handle_open_list_trash_videos_modal(self, body: dict, client: WebClient, ack: Ack, logger: Logger):
        """Return the list trash videos modal"""
        logger.info(body)
        ack()
